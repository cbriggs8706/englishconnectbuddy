  ...
  if (!user) {
    return (
      <Card className="border-0 bg-gradient-to-r from-amber-500 to-orange-500 text-white shadow-lg shadow-orange-500/30">
        <CardHeader>
          <CardTitle className="text-2xl font-black">Sign in to answer the confidence poll</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <p className="text-base text-white/95">
            We save one 0-5 confidence score for each lesson in your selected course.
          </p>
          <Link href="/profile">
    ...
    <div className="space-y-4">
      <Card className="border-0 bg-gradient-to-r from-cyan-600 via-sky-600 to-blue-600 text-white shadow-xl shadow-sky-500/30">
        <CardHeader className="pb-2">
          <CardTitle className="text-2xl font-black">Lesson Confidence Poll</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3">
          <p className="text-base text-sky-50">
            Course: <span className="font-extrabold">{selectedCourse ?? "Not selected"}</span>
          </p>
          <p className="text-base text-sky-100">Rate each lesson from 0 (not confident) to 5 (very confident).</p>
